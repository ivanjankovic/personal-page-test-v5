    ...
    return (
      <div>
        <main>
          ...
          {/* <a href="/made-with-2d" class="Components-2eeDh">
            <div class="source-client-source-2d-Components-HomeStyles-NewsImage-1xaRn source-client-source-2d-Components-HomeStyles-MadeWith2dImage-Ctyem">
              <img class="source-client-source-2d-Components-HomeStyles-KovaHero-2iZRR" src="https://cdn.2dimensions.com/features/kova_hero.png" />
            </div>
            <div class="source-client-source-2d-Components-HomeStyles-NewsContent-3eFrk">
              <h3>Made with 2Dimensions</h3>
              <div class="source-client-source-2d-Components-HomeStyles-NewsDesc-2up89">Discover real world projects created with our tools. Tag your posts with #MadeWith2D to get featured!</div>
